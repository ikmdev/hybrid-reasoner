...
public abstract class IntervalReasonerInternationalTestBase extends SnomedTestBase
		implements SnomedVersionInternational {

	protected SnomedOntology snomedOntology;

	@SuppressWarnings("unused")
	private static final Logger log = LoggerFactory.getLogger(IntervalReasonerInternationalTestBase.class);
